...
function user_login() {
  ...
  if (!$_POST['user_name'] || !$_POST['password']) {
    ...
    if (!$result || mysql_num_rows($result) < 1){
      $feedback =  '<img src="../pics/macmandwn.gif" width="23" height="28" />  ERROR - Deze accountaaam is niet gevonden of uw paswoord klopt niet';
      return $feedback;
    } else {
      if (mysql_result($result, 0, 'is_confirmed') == '1') {
	       ...
	       $feedback = 'ERROR - Jouw account is nog niet geaccordeerd door de email die verstuurd is aan het adres dat je  hebt opgegeven';
	       return $feedback;
      }
    }
  }
