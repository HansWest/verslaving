...
$hiero3="";
$hiero2="persoonlijk";
echo (menue("preferences", "prefs_aaa_menu", "menu", "het hoofdmenu voor de preferences"));
...
switch ($_SESSION['strategie']) {
 ...
 ///ik haaal de ".php" van de url af zodat de database beter kjan kals naam kan gebruiken????
...
<tr> 
    <td valign="top">&nbsp;</td>
    <td valign="top" align="right"><hr size="1" align="right" width="50%"><span class="smakopje4"><i>personalia</i></span></td>
  </tr>
<?php
echo (menue("gegevens", "persoon_ik", dbcheck(), "@@@ nog ***"));
echo (menue("partner", "persoon_partner", dbcheck(), "@@@ nog ***"));
?>
<tr> 
    <td valign="top">&nbsp;</td>
    <td valign="top" align="right"><hr size="1" align="right" width="50%"><span class="smakopje4"><i>alcohol</i></span></td>
  </tr>
<?php
echo (menue("de start", "versl_gesch1", dbcheck(), "@@@ nog ***"));
?>
<tr> 
    <td valign="top">&nbsp;</td>
    <td valign="top" align="right"><hr size="1" align="right" width="50%"><span class="smakopje4"><i>algemeen</i></span></td>
  </tr>
<tr> 
<td valign="top">&nbsp;</td>
...
<?php
echo (menue("contact", "info_contact", dbcheck(), "contact opnemen met de auteur"));
?>
<tr><td valign="top">&nbsp;</td>
