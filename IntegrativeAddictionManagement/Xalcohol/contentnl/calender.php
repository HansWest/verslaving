...
$naamzoekmnd = "december";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  pas je op voor de feestdagen?..";
			    break;
case 11:
$naamzoekmnd = "november";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  hoe reageer jij op de winter?";
			    break;
case 10:
$naamzoekmnd = "oktober";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  hoe reageer jij op de hersft?";
			    break;
case 9:
...
$naamzoekmnd = "augustus";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  vakantie verdient vaak aandacht...";
			    break;
case 7:
$naamzoekmnd = "juli";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  vakantie verdient vaak aandacht...";
...
case 5:
$naamzoekmnd = "mei";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  redelijk wat feestdagen deze maand (...)";
			    break;
case 4:
$naamzoekmnd = "april";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'>  redelijk wat feestdagen deze maand (...)";
...
case 1:
$naamzoekmnd = "januari";
			    $maandcomment="<img src='../pics/macsmiley.gif' border='0'> tja, de goede voornemens...";
		}		
$zoekjaar = date("Y"); 
 ...
 echo "<center><a href=".$_SERVER['PHP_SELF']."?jjjjmmdd=". date('Y-m-d')." class=\"menubutton\"> $naamzoekmnd $zoekjaar </a></center>"; 
 echo "</td></tr>\n"; 
 echo "<td align=\"left\"><a href=".$_SERVER['PHP_SELF']."?jjjjmmdd=". date('Y-m-d', mktime (0, 0, 0, $last_month, 1, $last_year))." class=\"menubutton\">&lt;&lt;&lt;&lt;&lt;</a></td>"; 
 echo "<td align=\"right\"><a href=".$_SERVER['PHP_SELF']."?jjjjmmdd=". date('Y-m-d', mktime (0, 0, 0, $next_month, 1, $next_year))." class=\"menubutton\">&gt;&gt;&gt;&gt;&gt;</a></td>";
echo "</table>\n"; 
...
if ($i <=1) { echo "<td class=\"weekdgn\">".date("W",mktime(0,0,0,$zoekmaand,1,$zoekjaar))."</td>";}
 ...
 /* Datum van vandaag */ 
 echo "<td class=\"klndr_nowtd\"><a href=".$_SERVER['PHP_SELF']."?jjjjmmdd=". date('Y-m-d', mktime (0, 0, 0, $zoekmaand,$zoekdag,$zoekjaar))."  class=\"kallnk\"><b>$zoekdag</b></a></td>\n"; 
 } else { 
 echo "<td class=\"klndr_normtd\"><a href=".$_SERVER['PHP_SELF']."?jjjjmmdd=". date('Y-m-d', mktime (0, 0, 0, $zoekmaand,$zoekdag,$zoekjaar))."  class=\"kallnk\">$zoekdag</a></td>\n"; 
 } 
 }
...
if ($maandcomment != "") {
 echo "<tr><td colspan=\"8\">$maandcomment</td></tr>\n"; 
}
 echo "</table>\n"; 
 echo "</td></tr>\n"; 
 echo "</table>\n"; 
