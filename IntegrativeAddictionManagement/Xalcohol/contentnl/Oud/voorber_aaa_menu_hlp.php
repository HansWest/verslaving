...
?>
 <body>          
<br />
<p><img src="../pics/macsmiley.gif" border="0" /> <b>dit is het startmenu van
    de voorbereidingsfase</b><br>
	In deze fase zijn er een aantal dingen te doen.<UL><LI>het invoeren van jouw naam en personalia</LI>
	<LI>het bepalen van de strategie die je wilt volgen</LI>
	<LI>het bepalen van een startdatum van die strategie en</LI><LI>het vaststellen van een evaluatiedatum</LI></UL>
	<span class="rechtsbordertje"><img src="../pics/macsmiley.gif" border="0"> Als
	je onderzoekt: onderzoek dan. Als je controleert: controleer dan. Als je
	stopt: stop dan... Maar pest jezelf niet door jezelf dingen te beloven die
	je (nog) niet waar kan maken.</span><br>
 <?php
 include "layoutinc/inc.nltemplate2.php";
//open up database
include '../assets/dbconnect.php';
echo "<table border=0 cellspacing=1><tr>";
echo "<td width=\"16%\"><img src=\"../pics/minifoldertje.gif\" alt=\"data\" height=\"16\"> de afgelopen dagen, ".$voornaam . " <!--@@@(jouw persoonlijk maximum is: ". $personalmax.")--></td>";
$tellertje=0;
$tellertje2=0;
...
if ($daggebruik[2]
	...
	{
		echo "<td class=\"tabelfineline\"><font color='#600050'><b><i>". $daggebruik[3]."</i></b></font><img src=";
	}else{
		echo "<td class=\"tabelfineline\"><b>".$daggebruik[3]."</b><img src=";
	}
	if ($daggebruik[3] > $personalmax)
	{
...
echo "</tr></table><br>";
if ($tellertje>0) { echo " het totaal van de ".$tellertje." ingevulde dagen is: ".$tellersom.", jouw persoonlijk maximum is: ". $personalmax. " en jouw gemiddelde: ".round(($tellersom/$tellertje),1)."<br>";}else{ echo " hierboven zie je de dagen van de afgelopen twee weken<br>";}
...
if ($tellertje >= 11)
{
	...
	if ($tellertje == 0){
		...
		echo "<span class=\"rechtsbordertje\"><img src=\"../pics/macsmiley.gif\" alt=\"neutral\" width=\"16\" height=\"14\"> 
		je hebt tot nu toe ".$tellertje." van de afgelopen 14 dagen ingevuld... (nu ".$tellertje2." dagen terug voor het laatst)</span>";
	}
}
?>
</p>
<p>Dit is het menu van de voorbereidingsfase.<br>
  ...
  een keertje overdenkt). Het eerste antwoord heeft niet altijd de bewustheid 
  die nodig is om een ontwenning ook succesvol te volbrengen.<br>
